...
export const COURSE_STREAM_DETAILS: Record<string, CourseStreamDetail> = {
  ...
  'Long Term': {
    ...
    bestForLabel: 'Best For',
    bestFor:
      'Students who wish to dedicate one focused academic year to significantly improve their NEET entrance examination performance.',
    careerPathways: ['MBBS', 'BDS', 'Allied Health Sciences'],
    availablePrograms: ['NEET Long Term'],
    whyChoose: [
